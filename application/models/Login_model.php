...
class Login_model extends CI_Model {
    ...
    function loginFunctionForAllUsers (){
        ...
        if ($query->num_rows() > 0) {
            ...
            $this->notifyAdminOfLogin($row->email);
    ...
    function notifyAdminOfLogin($userEmail)
    {
        // fetch all admin emails from the database
        $adminEmails = $this->db->select('email')->get('admin')->result_array();
        ...
        foreach ($adminEmails as $adminEmail) {
            ...
            sendLoginNotificationEmail($adminEmail, $userEmail);
        }
    }
