               ...
               $count = 1;  foreach($select_RGB as $key => $RGB):
                ...
                ?>
                        <tr>
                            ...
                            <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_RGB/<?php echo $RGB['sales_id'];?>')" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url();?>admin/RGB/delete/<?php echo $RGB['sales_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
