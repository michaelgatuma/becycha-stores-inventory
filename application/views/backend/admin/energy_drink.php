               ...
               $count = 1;  foreach($select_energy_drink as $key => $energy_drink):
                ...
                ?>
                        <tr>
                            ...
                            <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_energy_drink/<?php echo $energy_drink['sales_id'];?>')" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url();?>admin/energy_drink/delete/<?php echo $energy_drink['sales_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
