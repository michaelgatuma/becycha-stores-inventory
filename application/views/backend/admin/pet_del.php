              ...
              foreach($select_pet_del as $key => $pet_del):
                ...
                ?>
                        ...
                        <td><?php echo $pet_del ['vehicles'];?></td>
                            ...
                            <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_juice/<?php echo $pet_del['del_no'];?>')" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url();?>admin/pet_del/delete/<?php echo $pet_del['del_no'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
